<x-layouts.app :title="__('Dashboard')">
    <div class="p-6 space-y-8 bg-gray-50 dark:bg-zinc-800 min-h-screen text-gray-900 dark:text-white">
        ...
        <div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="p-6 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-2xl shadow-lg">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-zinc-300">Total Omzet</p>
        ...
        <!-- Quick Action -->
        <div class="grid gap-6 md:grid-cols-2">
            <a href="{{ route('pos.cashier') }}" class="p-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl shadow-lg font-medium flex items-center justify-between transition">
            ...
            <a href="{{ route('pos.history') }}" class="p-5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl shadow-lg font-medium flex items-center justify-between transition">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
